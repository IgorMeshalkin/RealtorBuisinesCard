...
export const getServices = () => {
    return [
        ...
        {id: 3, name: 'Обмен недвижимости', description: 'Организую для владельцев недвижимости продать свое жилье и купить другую недвижимость, которая лучше соответствует их потребностям и желаниям. Благодаря этому, они могут получить удобное и комфортное жилье, не тратя много времени и сил на поиск и продажу каждого объекта отдельно.'},
        {id: 4, name: 'Ипотека', description: 'Помогут вам определить, какую ипотеку можно получить, какую недвижимость вы можете позволить и какие документы необходимо подготовить для получения ипотеки. Кроме того, помогут найти наиболее выгодные предложения на рынке и выбрать наилучшие условия ипотечного кредитования, исходя из ваших потребностей и финансовых возможностей.'},
        ...
        {id: 6, name: 'Сопровождение сделки', description: 'Помощь в проведении юридических процедур при покупке или продаже недвижимости. Помогают грамотно оформить документы, оценить риски, провести переговоры и сделать все необходимые юридические процедуры.'},
